...
namespace Facturacion24.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(DbContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedores != null ? 
                          ...
                          Problem("Entity set 'DbContexto.Vendedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,PorcentajeComision,Estado")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,PorcentajeComision,Estado")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbContexto.Vendedores'  is null.");
            }
            var vendedor = await _context.Vendedores.FindAsync(id);
            if (vendedor != null)
            {
