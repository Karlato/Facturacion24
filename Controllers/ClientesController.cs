...
namespace Facturacion24.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreORazon,RNCOCedula,CuentaContable,Estado")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreORazon,RNCOCedula,CuentaContable,Estado")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
